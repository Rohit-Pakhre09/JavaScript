...
document.write(`If approved then the result will be 'true' if not then 'false': <br> ${(student=="No" || student=="no") && (internship=="Yes" || internship=="yes") && (fresher=="No" || fresher=="no") && experience>=0}`);