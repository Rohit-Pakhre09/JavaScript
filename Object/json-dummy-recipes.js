...
document.write(`Recipe's :-<br>`);
for (let i = 0; i < recipe_obj.recipes.length; i++) {
    document.write(`<br>Id: ${recipe_obj.recipes[i].id}<br>Name: ${recipe_obj.recipes[i].name}<br>Ingredients: ${recipe_obj.recipes[i].ingredients}<br>Instructions: <br> ${recipe_obj.recipes[i].instructions}<br>: ${recipe_obj.recipes[i].instructions} <br>Prepare Time: ${recipe_obj.recipes[i].prepTimeMinutes} <br>Cook Time: ${recipe_obj.recipes[i].cookTimeMinutes} <br>Serving: ${recipe_obj.recipes[i].servings} <br>Difficulty: ${recipe_obj.recipes[i].difficulty} <br>Cuisine: ${recipe_obj.recipes[i].cuisine} <br>Calories Per Saving: ${recipe_obj.recipes[i].caloriesPerServing} <br>Tags: ${recipe_obj.recipes[i].tags} <br>User ID: ${recipe_obj.recipes[i].userId} <br>Image: ${recipe_obj.recipes[i].image} <br>Rating: ${recipe_obj.recipes[i].rating} <br>Review Count: ${recipe_obj.recipes[i].reviewCount} <br>Meal Type: ${recipe_obj.recipes[i].mealType}`);
    document.write("<br>");
}