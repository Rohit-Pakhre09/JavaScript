...
document.write("To Do List:-<br><br>");
for (let i = 0; i < todo.todos.length; i++) {
    document.write(`Id: ${todo.todos[i].id} <br>To Do: ${todo.todos[i].todo} <br>Completed: ${todo.todos[i].completed} <br>User ID: ${todo.todos[i].userId}`);
